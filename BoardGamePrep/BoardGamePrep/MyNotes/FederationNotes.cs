...
namespace BoardGamePrep.MyNotes
{
    class FederationNotes
    {
        static void Main(string[] args)
        {
            ...
            //THREAT CARDS - these show the longterm threat that is going out against the humans. Could be Civil War, Khan, Alien Invasion, Robot Uprising, Interdimensional Assault
